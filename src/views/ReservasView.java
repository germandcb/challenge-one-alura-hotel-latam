...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		txtFechaE.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				...
				if(txtFechaE.getDate() != null && txtFechaS.getDate() != null) {
					if (validarFecha(txtFechaE.getDate(), txtFechaS.getDate())) {
						JOptionPane.showMessageDialog(null, "La fecha de entrada debe ser menor a la fecha de salida.");
					} else {
		...
		txtFechaS.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				...
				if(txtFechaE.getDate() != null && txtFechaS.getDate() != null) {
					if (validarFecha(txtFechaE.getDate(), txtFechaS.getDate())) {
						JOptionPane.showMessageDialog(null, "La fecha de salida debe ser mayor o igual a la fecha de entrada.");
					} else {
						lblValorSimbolo.setVisible(true);
						txtValor.setText(ValorReserva());
					}
	...
	private boolean validarFecha (java.util.Date fechaEntrada, java.util.Date fechaSalida) {
	...
	private String ValorReserva() {
   	 ...
   	 double precioDia = 25;
   	 long cantidadDias =  ((txtFechaS.getDate().getTime() - txtFechaE.getDate().getTime()) / 86400000) + 1;
   	 
   	 Double costoReserva = (cantidadDias * precioDia);  
   	 
   	 return costoReserva.toString();
    }
